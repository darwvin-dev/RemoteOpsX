import type { TerminalFont, Theme, UiFont } from "./settings";
...
const TERMINAL_THEMES: Record<ResolvedTheme, TerminalTheme> = {
  dark: {
    background: "#05080d", foreground: "#c9d4e0", cursor: "#2dd4bf", selectionBackground: "#1d4e73",
    black: "#0a0e14", red: "#f85149", green: "#3fb950", yellow: "#d29922", blue: "#4aa8ff",
    magenta: "#a371f7", cyan: "#2dd4bf", white: "#e6edf3",
  },
  light: {
    background: "#f8fafc", foreground: "#263548", cursor: "#087f75", selectionBackground: "#c7ece8",
    black: "#263548", red: "#c52f2a", green: "#18823b", yellow: "#9a6500", blue: "#176fba",
    magenta: "#7048bd", cyan: "#087f75", white: "#d5e0ec",
  },
  nord: {
    ...
    magenta: "#b48ead", cyan: "#88c0d0", white: "#e5e9f0", brightBlack: "#4c566a", brightWhite: "#eceff4",
  },
  dracula: {
    ...
    magenta: "#ff79c6", cyan: "#8be9fd", white: "#f8f8f2", brightBlack: "#6272a4", brightWhite: "#ffffff",
  },
  tokyo_night: {
    background: "#1a1b26", foreground: "#c0caf5", cursor: "#7aa2f7", selectionBackground: "#33467c",
    black: "#15161e", red: "#f7768e", green: "#9ece6a", yellow: "#e0af68", blue: "#7aa2f7",
    magenta: "#bb9af7", cyan: "#7dcfff", white: "#a9b1d6", brightBlack: "#414868", brightWhite: "#c0caf5",
  },
  solarized_dark: {
    ...
    magenta: "#d33682", cyan: "#2aa198", white: "#eee8d5", brightBlack: "#586e75", brightWhite: "#fdf6e3",
  },
  solarized_light: {
    background: "#fdf6e3", foreground: "#657b83", cursor: "#586e75", selectionBackground: "#eee8d5",
    black: "#073642", red: "#dc322f", green: "#859900", yellow: "#b58900", blue: "#268bd2",
    magenta: "#d33682", cyan: "#2aa198", white: "#eee8d5", brightBlack: "#839496", brightWhite: "#fdf6e3",
  },
};

export function terminalTheme(theme: Theme, systemPrefersDark: boolean): TerminalTheme {
  return TERMINAL_THEMES[resolveThemePreset(theme, systemPrefersDark)];
}
